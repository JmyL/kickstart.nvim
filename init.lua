...
vim.keymap.set('n', '<C-l>', '<cmd> vertical resize +5 <cr>', { desc = 'Vertical resize +5' })
vim.keymap.set('n', '<C-h>', '<cmd> vertical resize -5 <cr>', { desc = 'Vertical resize -5' })
vim.keymap.set('n', '<C-k>', '<cmd> horizontal resize +2 <cr>', { desc = 'Horizontal resize +2' })
vim.keymap.set('n', '<C-j>', '<cmd> horizontal resize -2 <cr>', { desc = 'Vwertical resize -2' })
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ps', function()
        builtin.live_grep {
          ...
          prompt_title = '[Pick] in Open Files',
        }
      end, { desc = '[P]ick [S]earch results in open files' })
      vim.keymap.set('n', '<leader>pa', builtin.live_grep { prompt_title = 'Grep' }, { desc = '[P]ick in [A]ll files' })
      vim.keymap.set('n', '<leader>po', builtin.builtin, { desc = '[P]ick [O]ptions' })
      vim.keymap.set('n', '<leader>pw', builtin.grep_string, { desc = '[P]ick current [W]ord' })
      ...
      vim.keymap.set('n', '<leader>pl', builtin.oldfiles, { desc = '[P]ick from Lo[G]s' })
